...
function App() {
  ...
  const handelChange = (e) => {
    ...
    if (e.target.value.length > 3 && e.target.value !== '') {
      ...
      .fromTo("#burger",{display: 'none', opacity: 0}, { display: 'flex', opacity: 1 });

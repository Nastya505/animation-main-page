...
import icon_input from "../../accets//image-group.svg"; 
...
function App() {
  ...
  const handelChange = (e) => {
    ...
    if (e.target.value.length > 3 && e.target.value !== '') {
      tl
      .fromTo('#input', { opacity: 1 }, {opacity: 0, width: '162px', backgroundColor: '#616161'})
      .fromTo('#block', { opacity: 1 }, {backgroundColor: '#464646', duration: .5})
      .to('#title', {opacity: 0})
      .to("#block", {display: 'none', duration: .5, opacity: 1, height: "80px" , margin:0, padding:0})
      .fromTo("#header", {display: 'none', opacity: .5}, {display: 'flex', opacity: 1} );
